...
function ClearObjects()
{
	...
	for ( var fallingObject:Transform in edgeTop )
	{
		...
		fallingObject.GetComponent.<Rigidbody2D>().velocity.x = Random.Range(objectFallSpeedX.x, objectFallSpeedX.y);
		fallingObject.GetComponent.<Rigidbody2D>().velocity.y = Random.Range(objectFallSpeedY.x, objectFallSpeedY.y);
